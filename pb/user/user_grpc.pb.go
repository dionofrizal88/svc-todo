...
type UserServiceClient interface {
	Get(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *userServiceClient) Get(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
	err := c.cc.Invoke(ctx, "/svc_todo.UserService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) Add(ctx context.Context, in *AddUserRequest, opts ...grpc.CallOption) (*AddUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/svc_todo.UserService/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	Get(context.Context, *Empty) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) Get(context.Context, *Empty) (*UserResponse, error) {
...
func _UserService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/svc_todo.UserService/Get",
	}
...
func _UserService_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/svc_todo.UserService/Add",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "svc_todo.UserService",
